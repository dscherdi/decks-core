...
export const ja: Translations = {
  ...
  testDeckCanvas: {
    ...
    section4: "空間カード",
    spatialIntro: "# 空間カード\n\nテキストノードをエッジでつなぎます。各エッジが 1 枚のカードになり、始点ノードが表、終点ノードが裏、エッジのラベルがヒントです。連鎖したノード（A → B → C）はすべてカードになります。単独の（つながっていない）ノードは、上の 4 つの形式で読み取られます。",
    spatialNodePhotosynthesis: "光合成",
    spatialNodeSunlight: "日光",
    spatialNodeGlucose: "グルコース",
    spatialEdgeNeeds: "必要とする",
    spatialEdgeProduces: "生成する",
  },
  ...
  testDeck: {
    ...
    formatsHint:
      "Decks は主に5つのフォーマットをサポートしています。ノートに最も適したものを選んでください。",
    ...
    bone2: "橈骨 (とうこつ)",
    bone3: "尺骨 (しゃっこつ)",
    section5: "5. テンプレート（カードの独自レイアウト）",
    section5Body:
      "表の見出しにタグを付けると、Decks はテンプレートフォルダー（設定 → カードテンプレート）のテンプレートファイルで各行を描画します。この表の見出しには #{tag} が付いているので、行は対応するテンプレートで描画されます。カード管理で行を編集すると、列ごとに入力欄が出ます。",
    templatesTableHeading: "漢字の語彙",
    templateTag: "語彙",
    templateFolderName: "Decks テンプレート",
    templateFileName: "語彙カード.md",
    tplColWord: "語",
    tplColReading: "読み",
    tplColMeaning: "意味",
    tplRow1Word: "火",
  ...
  anki: {
    title: "Anki からインポート",
    description: "Anki の .apkg エクスポートを Decks にインポートします。デッキ、カード、メディア、学習履歴がそのまま引き継がれます。",
    howItWorks: "仕組み：各 Anki デッキは Decks のファイルになり（デッキ階層はフォルダーとして保持されます）、ノートは見やすい表面／裏面のカードに変換され、メディアは保管庫にコピーされ、スケジュール／学習履歴がインポートされるので、カードは Anki で中断したところから再開できます。",
    fileLabel: "Anki ファイル",
    fileDesc: "Anki からエクスポートした .apkg ファイルを選択してください。",
    noFileSelected: "ファイルが選択されていません",
    targetFolderName: "保存先フォルダー",
    ...
    importButton: "インポート",
    importing: "インポート中…",
    importFailed: "インポートに失敗しました。詳細はコンソールを確認してください。",
    selectFileFirst: "先に .apkg ファイルを選択してください。",
    notAnApkg: "これは Anki の .apkg ファイルではありません。Anki からデッキを書き出して、それを選んでください。",
    progressReading: "コレクションを読み込み中…",
    progressWriting: "{deck} を書き込み中…",
    progressSyncing: "デッキを同期中…",
    progressImporting: "学習履歴をインポート中…",
  ...
  commands: {
    createExamDemoDeck: "デモ試験デッキを作成",
    cleanupOrphanedCards: "デッキのない孤立カードを整理",
    migrateFromSr: "Spaced Repetition プラグインから移行",
    importFromAnki: "Anki から取り込む（.apkg）",
    ...
    openAiGenerator: "AIでフラッシュカードを生成",
  },
  ...
  notices: {
    ...
    cardsRebuilt: "履歴から {count} 枚のスケジュールを復元しました。",
    ...
    errorStartingCram: "集中復習の開始エラー。詳細はコンソールを確認してください。",
  ...
  examDeck: {
    filename: "Decks — デモ試験.md",
    title: "デモ試験",
    intro:
      "このノートは試験デッキです。{tag} タグが付いているため、直下にタスクリストがある見出しはそれぞれ選択式の問題になり、正解の選択肢は `[x]` でチェックします。デッキの行をクリック（またはデッキのメニューを使用）して「試験を開始」を押すと試せます。",
    formatsHint:
      "以下にすべての問題形式を順に示します：単一解答、複数解答（全問正解の場合のみ得点）、正誤問題、入力式の短答、テーブルの行、穴埋め。このファイルをソースモードで開くと、それぞれの書き方を確認できます。問題の下の `%%comment%%` は、結果の見直し画面で表示される解説になります。",
    mcq1Front: "貴ガスはどの元素ですか？",
    mcq1OptA: "酸素",
    mcq1OptB: "アルゴン",
    mcq1OptC: "窒素",
    mcq1OptD: "塩素",
    mcq1Note: "第18族の元素は最外殻電子が満たされているため、化学的に不活性です。",
    mcq2Front: "次のうち貴ガスはどれですか？",
    mcq2OptA: "ヘリウム",
    mcq2OptB: "酸素",
    mcq2OptC: "アルゴン",
    mcq2OptD: "ネオン",
    tfFront: "ミトコンドリアは酸化的リン酸化が行われる場所である。",
    tfTrue: "正しい",
    tfFalse: "誤り",
    saFront: "細胞の「発電所」と呼ばれるものは何ですか？",
    saBack: "ミトコンドリア。",
    tableHeading: "元素記号",
    tColFront: "表面",
    tColBack: "裏面",
    ...
    tRow1Front: "金の元素記号は？",
    tRow1Back: "Au",
    tRow1Notes: "ラテン語の aurum に由来します。",
    tRow2Front: "鉄の元素記号は？",
    tRow2Back: "Fe",
    tRow2Notes: "ラテン語の ferrum に由来します。",
    clozeHeading: "水",
    clozeBody: "水は ==水素== と ==酸素== からできています。",
    outro:
      "「試験のセットアップ」ダイアログでは、問題数、制限時間、合格点などを選べます。復習と試験の結果は別々に記録されるため、同じカードで両方を使えます。",
  },
  exam: {
    startExam: "試験を開始",
    startReview: "復習を開始",
    setupTitle: "試験のセットアップ",
    eligibleCount: "{count} 問が出題可能",
    skippedCount: "{count} 問をスキップ（無効または採点不可）",
    skippedHint: "フラグの付いたカードはカード管理で確認してください。",
    noQuestions: "この選択範囲には出題できる試験問題がありません。",
    questionCountSetting: "問題数",
    questionCountAll: "0 = すべて",
    timeLimitSetting: "制限時間（分）",
    timeLimitOff: "0 = 制限なし",
    passScoreSetting: "合格に必要な最低点（%）",
    shuffleQuestionsSetting: "問題をシャッフル",
    shuffleOptionsSetting: "選択肢をシャッフル",
    feedbackTimingSetting: "フィードバック",
    feedbackEnd: "最後にまとめて",
    feedbackImmediate: "各問題の後",
    selectionModeSetting: "問題の選択",
    selectionRandom: "ランダム",
    selectionSequential: "ファイルの記載順",
    typedGradingSetting: "入力式解答の採点",
    gradingExact: "完全一致",
    gradingTolerant: "小さなタイプミスを許容",
    gradingSelf: "自己採点",
    optionLabelsSetting: "選択肢のラベル",
    optionLabelsLetters: "英字（a, b, c）",
    ...
    submitExam: "試験を提出",
    quit: "中断",
    quitConfirmTitle: "試験の放棄",
    quitConfirmBody: "この試験を放棄しますか？何も保存されません。",
    submitConfirmTitle: "試験を提出",
    submitConfirmUnanswered: "未解答の {count} 問は不正解として採点されます。",
    confirm: "確認",
    correct: "正解",
    incorrect: "不正解",
    unanswered: "未解答",
    ...
    failed: "不合格",
    timeUsed: "所要時間",
    previousAttempts: "受験履歴",
    retake: "再受験",
    close: "閉じる",
    notes: "ノート",
    invalidQuestionBadge: "無効な問題",
    answerTooLongBadge: "採点不可",
    invalidReasonNoCorrect: "正解がマークされていません",
    invalidReasonSingleOption: "選択肢が2つ以上必要です",
    ...
    examSettingsHeading: "試験のデフォルト",
    typeFlipWarningTitle: "試験問題を有効化",
    typeFlipWarningBody: "復習済みの {count} 枚のカードが試験問題に変わります。復習履歴は休眠中の識別子に退避され、この設定をオフに戻すと自動的に復元されます。",
    checkAnswer: "答えを確認",
    selfGradePrompt: "正解できましたか？",
    nextQuestion: "次の問題",
    previousQuestion: "前の問題",
    question: "問題",
    multipleCorrect: "この問題には正解が複数あります。",
    timeRemaining: "残り時間：",
    loadingExam: "試験を読み込み中…",
    loadingAnswers: "解答を読み込み中…",
    noStoredAnswers: "この受験の解答は保存されていません。",
    closeExam: "試験を閉じる",
    everyQuestion: "毎問",
    settingCount: "この試験の問題数。0 は対象すべて。",
    settingTimeLimit: "試験全体のカウントダウン。0 は無制限。",
    settingPassMark: "合格に必要な割合（0–100）。",
    settingSelection: "デッキから問題を選ぶ方法。",
    settingFeedback: "解答を表示するタイミング。",
    settingGrading: "入力した解答の判定方法。自己採点なら長い解答も認められます。",
  ...
  review: {
    ...
    unbury: "再表示",
    cardActions: "カード操作",
    cardSuspended: "カードを保留しました",
    cardUnsuspended: "カードの保留を解除しました",
    cardBuried: "カードを明日まで隠しました",
    cardReset: "カードの進捗をリセットしました",
    resetCardConfirmTitle: "カードをリセットしますか？",
    resetCardConfirmMessage:
      "このカードの進捗をリセットしますか？復習履歴は削除され、カードは新規状態に戻ります。この操作は取り消せません。",
    close: "閉じる",
    front: "表",
    back: "裏",
    progress: "進捗",
    ...
    scratchpad: "スクラッチパッド",
    scratchpadPen: "ペン",
    scratchpadEraser: "消しゴム",
    scratchpadText: "テキスト",
    scratchpadClear: "消去",
    scratchpadTextPlaceholder: "メモを入力…",
    ...
    copyAnswer: "裏をコピー",
    editMasks: "マスクを編集",
    refactorInstruction: "書き直しの指示",
    refactorPlaceholder: "このカードをどう変えますか？例：裏を短く、LaTeX を修正",
    refactorRewritten: "上に書き直しました — 確認してから保存してください。",
    refactorSaved: "元のノートに保存し、再同期しました。",
    clozeHint: "各答えを ==二重イコール== で囲むと穴埋めのままになります。",
    typeEditedElsewhere: "この種類のカードは作成した場所で編集します。復習中は編集できません。",
    loading: "復習を読み込み中…",
    backToDecks: "デッキに戻る",
    closeReview: "復習を閉じる",
    closeBrowse: "ブラウズを閉じる",
    closeCram: "詰め込みを閉じる",
    loadingCram: "詰め込みを読み込み中…",
    nothingToBrowse: "ブラウズするものがありません",
    deckHasNoCards: "このデッキにはまだカードがありません。",
    nextCard: "次のカード",
    previousCard: "前のカード",
    card: "カード",
    timeRemainingLabel: "残り時間：",
    youHeld: "継続日数",
    ttsRateSaved: "デッキのプロファイルに保存され、次のセッションはここから始まります。",
    examDrawDesc: "試験は、プロファイルで試験問題を有効にしたデッキの多肢選択カードと入力カードから出題されます。",
    deckDetail: "デッキの詳細",
    selectDeckPrompt: "デッキを選ぶと、枚数と学習の選択肢が表示されます。",
  ...
  manager: {
    ...
    suspendedBadge: "保留中",
    buriedBadge: "非表示",
    suspendedTooltip: "保留中（手動復習のみ）",
    buriedUntilTooltip: "{date} まで非表示",
    resetSelectedConfirmTitle: "選択したカードをリセットしますか？",
    resetSelectedConfirmMessage:
      "{count} 枚のカードの進捗をリセットしますか？これらのカードの復習履歴がすべて削除されます。この操作は取り消せません。",
    cardActions: "カード操作",
    ...
    noCardsMatch: "フィルターに合うカードがありません。",
    noCardsYet: "まだカードがありません。",
    tagToCreate: "ノートにタグを付けると、デッキとカードになります。",
    noCustomDecks: "手動のカスタムデッキはまだありません — 下で作成できます。",
    filterDeckHint: "ブラウズで表示中のフィルターから始まります。フィルターデッキは自動で最新になります。",
    noRulesMatchAll: "ルールがなければ、このデッキはすべてのカードに一致します。",
    typeEditedElsewhereList: "この種類のカードは作成した場所で編集します。一覧からは編集できません。",
    reset: "リセット",
    deckType: "デッキの種類",
    manual: "手動",
    manualDesc: "カードを自分で選ぶ",
    rulesDesc: "ルールに合うカードを、常に最新に",
    rules: "ルール",
    matchingCards: "一致するカード",
    selectAllShown: "表示中をすべて選択",
    selectedOnly: "選択中のみ",
    noCardsSearch: "検索に合うカードがありません。",
    noCardsSyncFirst: "まだカードがありません — まずデッキを同期してください。",
    namePlaceholder: "例：試験対策",
    cardDetail: "カードの詳細",
    backToCards: "カード一覧に戻る",
    selectCardHere: "カードを選ぶとここに表示されます。",
  },
  ...
  profiles: {
    refactorPromptLabel: "AIシステムプロンプト",
    refactorPromptDesc: "このプロファイルを使うデッキのカードをリファクタリングする際にAIが従う指示。空欄の場合は既定値を使用します。",
    refactorPromptPlaceholder: "例：回答を簡潔にし、文法を修正する。",
    sectionAiRefactor: "AIシステムプロンプト",
    title: "FSRS プロファイル",
    ...
    sectionReadAloud: "読み上げ",
    ttsVoiceLabel: "音声",
    ttsVoiceDesc: "復習中に読み上げボタンで使用する音声",
    ttsVoiceDefault: "システムの既定",
    ttsRateLabel: "速度",
    ttsRateDesc: "読み上げの再生速度",
    ttsUnavailable: "このデバイスでは読み上げを利用できません",
    ...
    noticeReadAloudRange: '読み上げ速度は {min} から {max} の間で指定してください',
    noticeInvalidLapseInterval: '再失敗の間隔が無効です',
    noticeQuestionCountRange: '問題数は 0 以上にしてください',
    noticeTimeLimitRange: '制限時間は 0 以上にしてください',
    noticePassScoreRange: '合格点は 0 から 100 の間で指定してください',
    ...
    modalTitle: "プロファイル",
    modalSubtitle: "プロファイルを設定し、どのデッキで使うかを一か所で選べます。",
    tabSettings: "設定",
    tabAssignments: "割り当て",
    activeProfileLabel: "有効なプロファイル",
    newProfileButton: "新規",
    newProfileName: "新しいプロファイル",
    assignmentsHeading: "{name} を使用するデッキとタグ",
    assignmentsExplainer: "このプロファイルをタグに適用すると、その配下のすべてのデッキがこれらの設定を継承します。デッキは1つのプロファイルのみ使用できます。",
    assignTagPlaceholder: "適用するタグを選択…",
    applyButton: "適用",
    assignmentsEmpty: "このプロファイルを使うデッキはまだありません。上でタグに適用してください。",
    assignmentMeta: "{decks} デッキ · {cards} カード",
    effectiveSettingsHeading: "実効設定",
    removeAssignmentConfirm: "「{tag}」からこのプロファイルを外しますか？デッキは継承元のプロファイルに戻ります。",
    noticeProfileDuplicated: "プロファイルを複製しました",
    copySuffix: " のコピー",
    defaultSuffix: "（既定）",
    nameDesc: "このプロファイルの名前。",
    headerLevelDesc: "カードの表として読む見出しレベル。",
    clozeDesc: "==ハイライト== した文字から穴埋めカードを作る。",
    examDesc: "見出しの下のタスクリストは多肢選択カードになります。",
    newLimitDesc: "新規カードの 1 日の上限を有効にする。",
    reviewLimitDesc: "復習カードの 1 日の上限を有効にする。",
    newLimitMaxDesc: "1 日に導入する新規カードの上限（0–9999）。",
    reviewLimitMaxDesc: "1 日の復習カードの上限（1–9999）。",
    retentionDesc: "目標の定着率（0.5–0.995）。",
    newAgainInterval: "新規カードの「もう一度」間隔",
    newAgainIntervalDesc: "新規カードで「もう一度」を押したときの間隔（例：1m）。",
    lapseAgainInterval: "失敗時の「もう一度」間隔",
    lapseAgainIntervalDesc: "復習カードで「もう一度」を押したときの間隔（例：10m）。",
    intervals: "間隔",
    clozeMaskDesc: "出題されない穴が復習中にどう見えるか。",
    ttsLanguageDesc: "システム音声が読む言語。自動は端末に従います。",
    ttsPreview: "現在の音声と速度を試聴。",
    ttsVoiceMissing: "保存した音声がこの端末にないため、下の言語を使います。",
    automatic: "自動",
    random: "ランダム",
    sections: "プロファイルのセクション",
    loading: "プロファイルを読み込み中…",
    noneYet: "まだプロファイルがありません。",
    availableWhenDb: "データベースが利用可能になるとプロファイルが表示されます。",
    tagToApply: "適用するタグ",
    tagDesc: "このプロファイルをタグに適用すると、その配下のデッキが設定を継承します。デッキが使えるプロファイルは 1 つだけです。",
    duplicate: "複製",
    examsHeading: "試験",
  },
  ...
  statistics: {
    ...
    timeframe: "期間",
    updating: "更新中…",
    waitingForDb: "カードデータベースを待っています…",
    tryAgain: "再試行",
    noneYet: "まだ統計がありません。",
    noneYetHint: "カードをいくつか復習すると、ここに進み具合が表示されます。",
    noReviewsInPeriod: "この期間の復習記録はありません。",
    notEnoughHistory: "復習履歴がまだ足りません。",
    cards: "カード",
    cardStateDistribution: "カード状態の分布",
    dueNext30: "今後 30 日間に期限が来るカード",
    reviewsAllTime: "累計の復習数",
    studyTimeAllTime: "累計の学習時間",
    timeInPeriod: "期間内の時間",
    passRateDesc: "間隔が 1 日以上のカードの正答率。",
  },
  ...
  filterBuilder: {
    ...
    allRules: "すべてのルール",
    anyRule: "いずれかのルール",
    noRulesYet: "ルールがありません — ルールのないフィルターはすべてのカードに一致します。",
    ruleField: "ルールの項目",
    ruleOperator: "ルールの演算子",
    ruleValue: "ルールの値",
    ruleMatching: "ルールの一致条件",
    selectDeck: "デッキを選択",
    selectTag: "タグを選択",
    selectType: "種類を選択",
    value: "値",
  ...
  modals: {
    ...
    aiBatch: {
      title: "AI一括リファクタリング",
      intro: "選択した{count}枚のカードを確認中。提案された各フィールドを承認または拒否します。",
      start: "開始",
      cancel: "キャンセル",
      close: "閉じる",
      retry: "再試行",
      ...
      stop: "停止",
      skipCard: "カードをスキップ",
      processing: "{total}件中{current}件を処理中…",
      waiting: "待機中…",
      done: "完了",
      noProposals: "変更の提案はありません",
      applied: "適用済み",
      skipped: "スキップ済み",
      failed: "失敗",
      summary: "適用{applied}件 · スキップ{skipped}件 · 失敗{failed}件",
      bulkButton: "AIでリファクタリング",
      suggestionFor: "{field}の提案",
      statusReady: "準備完了",
      statusAccepted: "承認済み",
      apply: "{count}件を適用",
      backToList: "戻る",
    ...
    aiGenerator: {
      ...
      generate: "生成",
      generating: "生成中…",
      continueGenerating: "生成を続ける",
      stop: "停止",
      streaming: "これまでに{count}件生成…",
      noCards: "まだカードがありません。下に生成内容を記述してください。",
      backToList: "戻る",
      selectPrompt: "表示するカードを選択",
      fieldFront: "表",
      fieldBack: "裏",
      fieldNotes: "メモ",
      keep: "残す",
      ...
      formatCanvas: "キャンバス",
      name: "ファイル名",
      namePlaceholder: "新しいデッキ",
      folder: "フォルダー",
      folderPlaceholder: "保管庫のルート",
      tag: "タグ",
      profile: "プロファイル",
      deck: "デッキ",
      save: "{count}件を保存",
      saving: "保存中…",
      saved: "{count}枚のカードを保存しました",
      saveFailed: "カードを保存できませんでした",
      nameRequired: "ファイル名を入力してください",
      deckRequired: "追加先のデッキを選択してください",
      ...
      debugSystem: "システム",
      debugUser: "ユーザー",
      debugPriorAssistant: "アシスタント（これまでのカード）",
      debugFollowup: "フォローアップ",
      debugImages: "画像",
      debugResponse: "応答",
      debugEmpty: "リクエストと応答を表示するには生成を実行してください。",
      debugToggle: "デバッグパネルの切り替え",
      debugOcr: "OCR の書き起こし",
      debugOcrPage: "{page} ページ",
      pdfChapters: "章",
      pdfClosePanel: "章のパネルを閉じる",
      pdfCloseTab: "この PDF を外す",
      pdfParseMode: "解析モード",
      pdfModeAuto: "自動（テキスト、スキャンは OCR）",
      pdfModeText: "テキストのみ",
      pdfModeOcr: "全ページを OCR",
      pdfSelectAll: "すべて選択",
      ...
      pdfClear: "クリア",
      pdfOcrProgress: "ページを読み込み中 {done}/{total}…",
      pdfCached: "キャッシュ済み",
      pdfNoChapters: "章が検出されませんでした。",
      addPdf: "PDF を添付",
      pdfFromVault: "Vault から",
      pdfFromComputer: "パソコンから",
      pdfTooLarge: "PDF が大きすぎます（最大 {max} MB）。",
      tooManyNotes: "添付できるノートは最大 {max} 件です。",
      tooManyImages: "添付できる画像は最大 {max} 枚です。",
    },
    editFlashcard: {
      aiRefactor: "AI でリファクタリング",
      aiRefactoring: "リファクタリング中…",
      aiSuggestion: "AI の提案",
      aiAccept: "承認",
      aiDecline: "拒否",
      aiNoChanges: "AI は変更を提案しませんでした",
      aiDrawerTitle: "AI リファクタリング",
      aiIncludeSourceContext: "ソースの文脈を含める（{file}）",
      aiPresetFixLatex: "LaTeX を修正",
      aiPresetSimplify: "説明を簡潔に",
      aiPresetTranslate: "英語に翻訳",
      aiCustomInstructionsPlaceholder: "このカードへのカスタム指示…",
      aiTargetScope: "対象フィールド",
      aiGenerate: "生成",
      aiPromptPlaceholder: "このカードをどのように修正するか記述してください…",
      aiAddNote: "ノートを添付",
      aiAddImage: "画像を添付",
      aiAddPdf: "PDF を添付",
      aiSend: "生成",
      aiModel: "モデル",
      aiAcceptVersion: "このバージョンを採用",
      aiDismiss: "破棄",
      aiShow: "AIアシスタントを表示",
      aiHide: "AIアシスタントを非表示",
      aiSplit: "分割",
      aiSplitToggle: "複数のカードに分割",
      aiAcceptSplit: "この分割を採用",
      aiSplitTitle: "{count} 枚のカードに分割",
      aiRemoveContext: "削除",
      aiDebugTitle: "直近のリクエスト / レスポンス",
      aiDebugSystem: "システム",
      aiDebugPrompt: "プロンプト",
      aiDebugResponse: "レスポンス",
      cancel: "キャンセル",
      save: "保存",
      saving: "保存中…",
      title: "カードを編集",
      ...
      fieldOptions: "選択肢",
      fieldSentence: "文",
      templateColumnsHint: "このカードはテンプレートを使っています。下で行の列を編集してください。",
      templateColumnFallback: "列 {n}",
    },
  },
  ...
  settings: {
    ai: {
      heading: "AI 機能",
      enabled: "AI 機能を有効にする",
      enabledDesc: "AI によるカードの書き直しを有効にします。API キーかローカルモデルが必要です。",
      provider: "プロバイダー",
      providerDesc: "書き直しに使う AI プロバイダー。",
      model: "モデル",
      modelDesc: "選択したプロバイダーのモデル名。",
      tier: "品質ティア",
      tierDesc: "Decks Pro がティアに応じてモデルを選びます。",
      modelCustom: "カスタム…",
      modelCustomLabel: "カスタムモデル",
      localBaseUrl: "ローカルサーバーの URL",
      localBaseUrlDesc: "Ollama や LM Studio のような OpenAI 互換ローカルサーバーのベース URL。",
      apiKey: "API キー",
      apiKeyDesc: "端末間で同期されないローカルファイルに保存されます。",
      apiKeyPlaceholder: "API キーを貼り付け",
      providerGemini: "Google Gemini",
      providerOpenai: "OpenAI",
      providerClaude: "Anthropic Claude",
      providerLocal: "ローカル／カスタムのエンドポイント",
      providerDecksPro: "Decks Pro",
      serverUrl: "サーバー URL",
      serverUrlDesc: "Decks Pro のバックエンド URL。空なら既定値を使います。",
      siteUrl: "ウェブサイト URL",
      siteUrlDesc: "Decks Pro のウェブサイト URL。空欄の場合は既定値を使用します。",
      accountLoading: "\u30a2\u30ab\u30a6\u30f3\u30c8\u3092\u8aad\u307f\u8fbc\u307f\u4e2d\u2026",
      accountError: "\u30a2\u30ab\u30a6\u30f3\u30c8\u60c5\u5831\u3092\u8aad\u307f\u8fbc\u3081\u307e\u305b\u3093\u3067\u3057\u305f\u3002\u63a5\u7d9a\u3092\u78ba\u8a8d\u3057\u3066\u304f\u3060\u3055\u3044\u3002",
      accountRefresh: "\u66f4\u65b0",
      trialActive: "\u7121\u6599\u30c8\u30e9\u30a4\u30a2\u30eb \u2014 \u7d04 100 \u679a\u306e\u30ab\u30fc\u30c9\u3001\u307e\u305f\u306f 10 \u30da\u30fc\u30b8\u306e PDF\u3002",
      ...
      signInPending: "ブラウザーでサインインを完了してから、ここに戻ってください。",
      signInSuccess: "Decks Pro にサインインしました。",
      signInFailed: "サインインに失敗しました。設定からもう一度お試しください。",
      signOut: "サインアウト",
      signOutDone: "Decks Pro からサインアウトしました。",
      subscribe: "登録する",
      subscribeDesc: "\u6708\u984d 9.99 \u30e6\u30fc\u30ed \u2014 \u7d04 20,000 \u679a\u306e\u30ab\u30fc\u30c9\u3001\u307e\u305f\u306f 5,000 \u30da\u30fc\u30b8\u306e PDF\u3002",
      manageSubscription: "サブスクリプションを管理",
      openAccount: "アカウントページを開く",
      subscriptionStatus: "サブスクリプション",
      subscriptionNone: "有効なサブスクリプションがありません。登録すると生成を開始できます。",
      subscriptionActive: "有効",
      subscriptionTrial: "試用中",
      subscriptionPastDue: "支払い期限切れ",
      subscriptionCancelled: "解約済み — 期間終了まで有効",
      subscriptionExpired: "期限切れ",
      subscriptionPaused: "一時停止中",
      enableDesc: "カード生成とカード編集画面の AI 操作を有効にします。",
      baseUrl: "ベース URL",
      baseUrlDesc: "この端末から接続できる、ローカルまたは自前でホストしたモデルのエンドポイント。",
      modelId: "モデル ID",
      modelIdDesc: "サーバーが公開しているモデル ID。",
      proAccount: "DecksMD Pro アカウント",
      proDesc: "DecksMD アカウントを使えば、自分の API キーなしでカードを生成できます。",
      noKeyNeeded: "DecksMD Pro に自分のキーは不要です。他のプロバイダーはあなたのアカウントを直接使います。",
      email: "メールアドレス",
      password: "パスワード",
      noAccountYet: "アカウントをお持ちでないですか？",
      createOne: "decksmd.app で作成",
      manageAccount: "アカウントを管理",
      billingDesc: "請求とリンク済み端末はウェブサイトにあります。",
      seePlans: "プランを見る",
      open: "開く",
      clearKey: "クリア",
      deviceSignedIn: "この端末はサインイン済みなので、キーは不要です。",
    },
    language: {
      heading: "言語",
      name: "プラグインの言語",
    ...
    templates: {
      heading: "カードテンプレート",
      folder: "テンプレートフォルダー",
      folderDesc: "テンプレートファイルのフォルダー。各ファイルの decks-tags が表の行やノートに結び付けます。",
      folderDefault: "無効（テンプレートフォルダーなし）",
      previewHeading: "プレビュー",
      previewHint: "プレビューはサンプル行のデータを使います。",
      noTemplates: "選択したフォルダーにはまだテンプレートが見つかりません。",
      notesLabel: "ノート",
    },
    ...
    backup: {
      ...
      rebuildState: "カードのスケジュールを再構築",
      rebuildStateDesc: "新規に見えるがレビュー履歴が残っているカードのスケジュールを復元します。",
      rebuildStateButton: "履歴から再構築",
    },
    fsrs: {
      heading: "アルゴリズムの調整",
      optimize: "パラメータを最適化",
    ...
    paths: {
      ...
      pdfCacheFolder: "PDF OCR キャッシュフォルダー",
      pdfCacheFolderDesc: "PDF OCR のページ単位のテキストをキャッシュするフォルダー。同じ PDF を二度読まずに済みます。",
    ...
    hideIdentityMarkers: "カード識別マーカーを隠す",
    scanFolderDesc: "スキャンを特定のフォルダーに限定します。空なら全体を対象にします。",
    foldersRelativeDesc: "フォルダーは Vault からの相対パスです。空なら既定の場所を使います。",
    syncLogFolderDesc: "端末ごとの同期ログを置くフォルダー。既定は Vault のルート。",
    syncLogIdDesc: "この端末の同期ログファイルを識別します。フォルダーの変更は次回 Vault を開いたときに反映されます。",
    canvasTagRule: "canvas タグは # で始まり、小文字・数字・ハイフン・アンダースコア・スラッシュのみ使えます。",
    fallbackExamDesc: "独自のプロファイルを持たないデッキ（カスタムデッキなど）が使います。プロファイルのあるデッキはそちらの試験設定を使います。",
  },
  cardEdit: {
    typeMismatch: "編集タイプ {edit} はカードタイプ {card} と一致しません",
    vaultReadOnly: "この Vault は読み取り専用で開いています。",
    canvasNotHere: "Canvas カードはここでは編集できません。",
    couldNotRead: "{file} を読み込めませんでした: {reason}",
    cardNotFound: "このカードをソースノート内で見つけられませんでした。",
    noteChanged: "このカードを読み込んだあとにノートが変更されました。再読み込みしてやり直してください。",
    tableRowUnparseable: "表の行を解析できなくなりました。",
    tableRowChanged: "このカードを読み込んだあとに表の行が変更されました。",
    clozeChanged: "このカードを読み込んだあとに穴埋めの内容が変更されました。",
    clozeRowUnparseable: "穴埋めを含む表の行を解析できなくなりました。",
    clozeRowInvalid: "穴埋めを含む行は有効な表の行ではありません。",
    emptyHeaderSegment: "見出しセクションが空です。",
    anchorNotHeader: "アンカー行が見出しではありません。",
    notATableRow: "有効な表の行ではありません。",
    noNotesColumn: "この表にはメモ列がありません。",
    separatorNotFound: "メモ列を追加するための表の区切り行が見つかりませんでした。",
    frontEmpty: "表面のテキストは空にできません。",
    headerEmpty: "見出しのテキストは空にできません。",
    clozeNeedsSpan: "穴埋めには ==範囲== が少なくとも 1 つ必要です。",
  },
};
