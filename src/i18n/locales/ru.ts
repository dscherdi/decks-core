...
export const ru: Translations = {
  ...
  settings: {
    ai: {
      ...
      providerLocal: "Локально (совместимо с OpenAI)",
      ...
      accountSignedOut: "Войдите, чтобы использовать Decks Pro без лицензионного ключа.",
      ...
      baseUrl: "Базовый URL",
      baseUrlDesc: "Совместимая с OpenAI точка доступа, достижимая с этого устройства.",
