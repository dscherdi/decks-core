...
export const fr: Translations = {
  ...
  mobileApp: {
    heading: "DecksMD pour iPhone et iPad",
    body: "Le même coffre, le même markdown, révisé sur votre téléphone. Cartes, planification et historique restent dans vos fichiers.",
  ...
  testDeckCanvas: {
    ...
    section4: "Cartes spatiales",
    spatialIntro: "# Cartes spatiales\n\nRelie des nœuds de texte par des arêtes. Chaque arête devient une carte — le nœud de départ est le recto, celui d’arrivée le verso, le libellé de l’arête un indice. Les nœuds d’une chaîne (A → B → C) génèrent tous des cartes. Les nœuds isolés restent lus avec les quatre formats ci-dessus.",
    spatialNodePhotosynthesis: "Photosynthèse",
    spatialNodeSunlight: "Lumière du soleil",
    spatialNodeGlucose: "Glucose",
    spatialEdgeNeeds: "a besoin de",
    spatialEdgeProduces: "produit",
  },
  ...
  testDeck: {
    ...
    bone2: "Radius",
    bone3: "Ulna (Cubitus)",
    section5: "5. Modèles (mises en page personnalisées)",
    section5Body:
      "Étiquette le titre d’un tableau et Decks rend chaque ligne via un fichier modèle de ton dossier de modèles (Réglages → Modèles de cartes). Le titre de ce tableau porte #{tag}, donc ses lignes sont rendues avec le modèle correspondant — modifie une ligne dans le gestionnaire de cartes et tu auras un champ par colonne.",
    templatesTableHeading: "Vocabulaire kanji",
    templateTag: "vocabulaire",
    templateFolderName: "Modèles Decks",
    templateFileName: "Carte de vocabulaire.md",
    tplColWord: "Mot",
    tplColReading: "Lecture",
    tplColMeaning: "Sens",
    tplRow1Word: "火",
    tplRow1Reading: "ひ",
    tplRow1Meaning: "feu",
  ...
  anki: {
    ...
    notAnApkg: "Ce n'est pas un fichier .apkg Anki. Exportez un paquet depuis Anki et choisissez-le.",
  ...
  commands: {
    ...
    migrateFromSr: "Migrer depuis le plugin Spaced Repetition",
    importFromAnki: "Importer depuis Anki (.apkg)",
  ...
  notices: {
    ...
    cardsRebuilt: "Planification restaurée pour {count} cartes depuis l’historique.",
  ...
  exam: {
    ...
    selfGradePrompt: "Avais-tu juste ?",
    nextQuestion: "Question suivante",
    previousQuestion: "Question précédente",
    question: "Question",
    multipleCorrect: "Cette question a plusieurs bonnes réponses.",
    timeRemaining: "Temps restant :",
    loadingExam: "Chargement de l’examen…",
    loadingAnswers: "Chargement des réponses…",
    noStoredAnswers: "Aucune réponse n’a été enregistrée pour cette tentative.",
    closeExam: "Fermer l’examen",
    everyQuestion: "Chaque question",
    settingCount: "Nombre de questions. 0 = toutes celles éligibles.",
    settingTimeLimit: "Compte à rebours pour tout l’examen. 0 = sans limite.",
    settingPassMark: "Pourcentage requis pour réussir (0–100).",
    settingSelection: "Comment les questions sont choisies dans le paquet.",
    settingFeedback: "Quand les réponses sont révélées.",
    settingGrading: "Comment les réponses saisies sont vérifiées. L’auto-évaluation accepte aussi les réponses longues.",
  ...
  deckList: {
    ...
    flatView: "Vue à plat",
    viewToggle: "Vue liste des paquets",
  ...
  review: {
    ...
    scratchpadPen: "Stylo",
    scratchpadEraser: "Gomme",
    scratchpadText: "Texte",
    scratchpadClear: "Effacer",
    scratchpadTextPlaceholder: "Saisir des notes…",
    ...
    copyAnswer: "Copier le verso",
    editMasks: "Modifier les masques",
    refactorInstruction: "Consigne de réécriture",
    refactorPlaceholder: "Comment cette carte doit-elle changer ? p. ex. raccourcir le verso, corriger le LaTeX",
    refactorRewritten: "Réécrit ci-dessus — vérifie, puis enregistre.",
    refactorSaved: "Enregistré dans la note source, puis resynchronisé.",
    clozeHint: "Entoure chaque réponse de ==doubles égales== pour qu’elle reste un texte à trous.",
    typeEditedElsewhere: "Ce type de carte se modifie là où il a été créé, pas pendant la révision.",
    loading: "Chargement de la révision…",
    backToDecks: "Retour aux paquets",
    closeReview: "Fermer la révision",
    closeBrowse: "Fermer l’exploration",
    closeCram: "Fermer le bachotage",
    loadingCram: "Chargement du bachotage…",
    nothingToBrowse: "Rien à explorer",
    deckHasNoCards: "Ce paquet n’a pas encore de cartes.",
    nextCard: "Carte suivante",
    previousCard: "Carte précédente",
    card: "Carte",
    timeRemainingLabel: "Temps restant :",
    youHeld: "Tu as tenu",
    ttsRateSaved: "Enregistré dans le profil du paquet : la prochaine session démarrera ici.",
    examDrawDesc: "Les examens puisent dans les cartes à choix multiples et à saisie des paquets dont le profil active les questions d’examen.",
    deckDetail: "Détail du paquet",
    selectDeckPrompt: "Choisis un paquet pour voir ses comptes et options d’étude.",
  ...
  manager: {
    ...
    deckScope: "Portée du paquet",
    sortOrder: "Tri",
    sortDueSoonest: "À réviser en premier",
    sortFrontAZ: "Recto A–Z",
    sortRecent: "Révisées récemment",
    filters: "Filtres",
    selectNone: "Tout désélectionner",
    source: "Source",
    loadingCards: "Chargement des cartes…",
    loadingDecks: "Chargement des paquets…",
    noCardsMatch: "Aucune carte ne correspond à tes filtres.",
    noCardsYet: "Pas encore de cartes.",
    tagToCreate: "Étiquette tes notes pour en faire des paquets et des cartes.",
    noCustomDecks: "Aucun paquet personnalisé pour l’instant — crées-en un ci-dessous.",
    filterDeckHint: "Part des filtres actuellement affichés dans Parcourir. Un paquet filtré se tient à jour tout seul.",
    noRulesMatchAll: "Sans règles, ce paquet correspond à toutes les cartes.",
    typeEditedElsewhereList: "Ce type de carte se modifie là où il a été créé, pas depuis la liste.",
    reset: "Réinitialiser",
    deckType: "Type de paquet",
    manual: "Manuel",
    manualDesc: "Choisir les cartes toi-même",
    rulesDesc: "Cartes correspondant aux règles, tenues à jour",
    rules: "Règles",
    matchingCards: "Cartes correspondantes",
    selectAllShown: "Tout sélectionner",
    selectedOnly: "Sélection seulement",
    noCardsSearch: "Aucune carte ne correspond à ta recherche.",
    noCardsSyncFirst: "Pas encore de cartes — synchronise d’abord un paquet.",
    namePlaceholder: "p. ex. Révisions d’examen",
    cardDetail: "Détail de la carte",
    backToCards: "Retour aux cartes",
    selectCardHere: "Choisis une carte pour la voir ici.",
  },
  ...
  profiles: {
    ...
    noticeReadAloudRange: 'La vitesse de lecture doit être comprise entre {min} et {max}',
    noticeInvalidLapseInterval: 'Intervalle de rechute invalide',
    noticeQuestionCountRange: 'Le nombre de questions doit être supérieur ou égal à 0',
    noticeTimeLimitRange: 'La limite de temps doit être supérieure ou égale à 0',
    noticePassScoreRange: 'Le score minimum de réussite doit être compris entre 0 et 100',
    ...
    modalTitle: "Profils",
    modalSubtitle: "Configurez un profil et choisissez quels paquets l'utilisent, au même endroit.",
    tabSettings: "Paramètres",
    tabAssignments: "Affectations",
    activeProfileLabel: "Profil actif",
    newProfileButton: "Nouveau",
    newProfileName: "Nouveau profil",
    assignmentsHeading: "Paquets et étiquettes utilisant {name}",
    assignmentsExplainer: "Appliquez ce profil à une étiquette et chaque paquet en dessous en hérite. Un paquet ne peut utiliser qu'un seul profil.",
    assignTagPlaceholder: "Choisir une étiquette à appliquer…",
    applyButton: "Appliquer",
    assignmentsEmpty: "Aucun paquet n'utilise ce profil pour l'instant. Appliquez-le à une étiquette ci-dessus.",
    assignmentMeta: "{decks} paquets · {cards} cartes",
    effectiveSettingsHeading: "Paramètres effectifs",
    removeAssignmentConfirm: "Retirer ce profil de « {tag} » ? Ses paquets reviendront au profil hérité.",
    noticeProfileDuplicated: "Profil dupliqué",
    copySuffix: " copie",
    defaultSuffix: "(PAR DÉFAUT)",
    nameDesc: "Nom de ce profil.",
    headerLevelDesc: "Niveau de titre lu comme recto des cartes.",
    clozeDesc: "Créer des cartes à trous à partir du texte ==surligné==.",
    examDesc: "Une liste de tâches sous un titre devient une carte à choix multiples.",
    newLimitDesc: "Activer une limite quotidienne de nouvelles cartes.",
    reviewLimitDesc: "Activer une limite quotidienne de révisions.",
    newLimitMaxDesc: "Nombre maximal de nouvelles cartes par jour (0–9999).",
    reviewLimitMaxDesc: "Nombre maximal de révisions par jour (1–9999).",
    retentionDesc: "Taux de rétention visé (0,5–0,995).",
    newAgainInterval: "Intervalle « Encore » pour une nouvelle carte",
    newAgainIntervalDesc: "Intervalle après « Encore » sur une nouvelle carte (p. ex. 1m).",
    lapseAgainInterval: "Intervalle « Encore » après oubli",
    lapseAgainIntervalDesc: "Intervalle après « Encore » sur une carte en révision (p. ex. 10m).",
    intervals: "Intervalles",
    clozeMaskDesc: "Apparence des trous non testés pendant la révision.",
    ttsLanguageDesc: "Langue de lecture de la voix système. Automatique suit l’appareil.",
    ttsPreview: "Écouter la voix et la vitesse actuelles.",
    ttsVoiceMissing: "La voix enregistrée n’est pas installée ici ; la langue ci-dessous est utilisée à la place.",
    automatic: "Automatique",
    random: "Aléatoire",
    sections: "Sections du profil",
    loading: "Chargement des profils…",
    noneYet: "Pas encore de profils.",
    availableWhenDb: "Les profils apparaissent dès que la base est disponible.",
    tagToApply: "Étiquette à appliquer",
    tagDesc: "Applique ce profil à une étiquette et chaque paquet en dessous hérite de ces réglages. Un paquet ne peut utiliser qu’un profil.",
    duplicate: "Dupliquer",
  ...
  statistics: {
    ...
    loading: "Chargement…",
    scope: "Portée des statistiques",
    timeframe: "Période",
    updating: "Actualisation…",
    waitingForDb: "En attente de la base de cartes…",
    tryAgain: "Réessayer",
    noneYet: "Pas encore de statistiques.",
    noneYetHint: "Révise quelques cartes et ta progression apparaîtra ici.",
    noReviewsInPeriod: "Aucune révision enregistrée sur cette période.",
    notEnoughHistory: "Pas encore assez d’historique.",
    cards: "Cartes",
    cardStateDistribution: "Répartition des états de cartes",
    dueNext30: "Cartes à réviser sur les 30 prochains jours",
    reviewsAllTime: "Révisions au total",
    studyTimeAllTime: "Temps d’étude au total",
    timeInPeriod: "Temps sur la période",
    passRateDesc: "Taux de réussite sur les cartes révisées à un intervalle d’au moins un jour.",
  },
  ...
  filterBuilder: {
    ...
    noRulesYet: "Pas encore de règles — un filtre sans règle correspond à toutes les cartes.",
    ruleField: "Champ de la règle",
    ruleOperator: "Opérateur de la règle",
    ruleValue: "Valeur de la règle",
    ruleMatching: "Correspondance des règles",
    selectDeck: "Choisir un paquet",
    selectTag: "Choisir une étiquette",
    selectType: "Choisir un type",
    value: "Valeur",
    badgeType: "Type",
    badgeInterval: "Intervalle",
    badgeReps: "Rép.",
    badgeNot: "Sans {label}",
    badgeNotText: "pas « {value} »",
  },
  ...
  modals: {
    ...
    purgeDatabase: {
      ...
      confirmPlaceholder: "SUPPRIMER TOUTES LES DONNÉES",
    ...
    aiGenerator: {
      ...
      continueGenerating: "Continuer à générer",
      stop: "Arrêter",
      ...
      debugTitle: "Débogage",
      debugSystem: "Système",
      debugUser: "Utilisateur",
      debugPriorAssistant: "Assistant (cartes générées)",
      debugFollowup: "Suivi",
      debugImages: "Images",
      debugResponse: "Réponse",
      debugEmpty: "Lancez une génération pour voir la requête et la réponse.",
      debugToggle: "Afficher/masquer le panneau de débogage",
      debugOcr: "Transcriptions OCR",
      debugOcrPage: "Page {page}",
      pdfChapters: "Chapitres",
      pdfClosePanel: "Fermer le panneau des chapitres",
      pdfCloseTab: "Retirer ce PDF",
      pdfParseMode: "Mode d’analyse",
      pdfModeAuto: "Auto (texte, OCR si scanné)",
      pdfModeText: "Texte seulement",
      pdfModeOcr: "OCR sur toutes les pages",
      pdfSelectAll: "Tout choisir",
      ...
      pdfClear: "Effacer",
      pdfOcrProgress: "Lecture des pages {done}/{total}…",
      pdfCached: "en cache",
      pdfNoChapters: "Aucun chapitre détecté.",
      addPdf: "Joindre un PDF",
      pdfFromVault: "Depuis le vault",
      pdfFromComputer: "Depuis l’ordinateur",
      pdfTooLarge: "Le PDF est trop volumineux (max {max} Mo).",
      tooManyNotes: "Tu peux joindre au maximum {max} notes.",
      tooManyImages: "Tu peux joindre au maximum {max} images.",
    },
    editFlashcard: {
      ...
      fieldSentence: "Phrase",
      templateColumnsHint: "Cette carte utilise un modèle — modifie ses colonnes ci-dessous.",
      templateColumnFallback: "Colonne {n}",
    },
  },

  settings: {
    ai: {
      heading: "Fonctions IA",
      enabled: "Activer les fonctions IA",
      enabledDesc: "Active la réécriture de cartes par l’IA. Nécessite une clé API ou un modèle local.",
      provider: "Fournisseur",
      providerDesc: "Quel fournisseur d’IA utiliser pour la réécriture.",
      model: "Modèle",
      modelDesc: "Nom du modèle pour le fournisseur choisi.",
      tier: "Niveau de qualité",
      tierDesc: "Decks Pro choisit le modèle selon le niveau.",
      modelCustom: "Personnalisé…",
      modelCustomLabel: "Modèle personnalisé",
      localBaseUrl: "URL du serveur local",
      localBaseUrlDesc: "URL de base d’un serveur local compatible OpenAI comme Ollama ou LM Studio.",
      apiKey: "Clé API",
      apiKeyDesc: "Stockée dans un fichier local qui n’est pas synchronisé entre appareils.",
      apiKeyPlaceholder: "Coller la clé API",
      providerGemini: "Google Gemini",
      providerOpenai: "OpenAI",
      providerClaude: "Anthropic Claude",
      providerLocal: "Point de terminaison local ou personnalisé",
      providerDecksPro: "Decks Pro",
      serverUrl: "URL du serveur",
      serverUrlDesc: "URL du backend Decks Pro. Laisser vide pour la valeur par défaut.",
      siteUrl: "URL du site web",
      siteUrlDesc: "URL du site Decks Pro. Laissez vide pour utiliser la valeur par défaut.",
      accountLoading: "Chargement du compte\u2026",
      accountError: "Impossible de charger les informations du compte. V\u00e9rifiez votre connexion.",
      accountRefresh: "Actualiser",
      trialActive: "Essai gratuit \u2014 environ 100 cartes ou 10 pages de PDF.",
      trialExhausted: "Essai gratuit \u00e9puis\u00e9. Abonnez-vous pour continuer \u00e0 g\u00e9n\u00e9rer.",
      dailyLimitReached: "Limite quotidienne atteinte. Elle se r\u00e9initialise demain.",
      account: "Compte Decks Pro",
      accountSignedOut: "Connectez-vous pour utiliser Decks Pro.",
      accountSignedInAs: "Connecté en tant que {email}",
      accountSignedIn: "Connecté",
      signIn: "Se connecter à Decks Pro",
      signInPending: "Terminez la connexion dans votre navigateur, puis revenez ici.",
      signInSuccess: "Connecté à Decks Pro.",
      signInFailed: "Échec de la connexion. Réessayez depuis les paramètres.",
      signOut: "Se déconnecter",
      signOutDone: "Déconnecté de Decks Pro.",
      subscribe: "S'abonner",
      subscribeDesc: "9,99 \u20ac par mois \u2014 environ 20 000 cartes ou 5 000 pages de PDF.",
      manageSubscription: "Gérer l'abonnement",
      openAccount: "Ouvrir la page du compte",
      subscriptionStatus: "Abonnement",
      subscriptionNone: "Aucun abonnement actif. Abonnez-vous pour commencer à générer.",
      subscriptionActive: "Actif",
      subscriptionTrial: "Période d'essai",
      subscriptionPastDue: "Paiement en retard",
      subscriptionCancelled: "Annulé — actif jusqu'à la fin de la période",
      subscriptionExpired: "Expiré",
      subscriptionPaused: "En pause",
      enableDesc: "Active la génération de cartes et les actions IA dans l’éditeur.",
      baseUrl: "URL de base",
      baseUrlDesc: "Un point de terminaison de modèle local ou auto-hébergé, joignable depuis cet appareil.",
      modelId: "Identifiant du modèle",
      modelIdDesc: "L’identifiant de modèle exposé par ton serveur.",
      proAccount: "Compte DecksMD Pro",
      proDesc: "Utilise ton compte DecksMD pour générer des cartes sans clé API personnelle.",
      noKeyNeeded: "DecksMD Pro n’a pas besoin de ta clé. Les autres fournisseurs utilisent directement ton compte.",
      email: "E-mail",
      password: "Mot de passe",
      noAccountYet: "Pas encore de compte ?",
      createOne: "Crées-en un sur decksmd.app",
      manageAccount: "Gérer le compte",
      billingDesc: "La facturation et les appareils liés se trouvent sur le site.",
      seePlans: "Voir les offres",
      open: "Ouvrir",
      clearKey: "Effacer",
      deviceSignedIn: "Cet appareil est connecté, aucune clé n’est nécessaire.",
    },
    language: {
      heading: "Langue",
    ...
    templates: {
      heading: "Modèles de cartes",
      folder: "Dossier des modèles",
      folderDesc: "Dossier des fichiers modèles. Les decks-tags de chaque fichier le lient à des lignes de tableau ou à des notes.",
      folderDefault: "Désactivé (aucun dossier de modèles)",
      previewHeading: "Aperçu",
      previewHint: "L’aperçu utilise des données d’exemple.",
      noTemplates: "Aucun modèle trouvé pour l’instant dans le dossier choisi.",
      notesLabel: "Notes",
    },
    ...
    backup: {
      ...
      rebuildState: "Reconstruire la planification",
      rebuildStateDesc: "Restaure la planification des cartes affichées comme nouvelles mais qui ont un historique.",
      rebuildStateButton: "Reconstruire depuis l’historique",
    },
    fsrs: {
    ...
    paths: {
      ...
      pdfCacheFolder: "Dossier de cache OCR des PDF",
      pdfCacheFolderDesc: "Dossier contenant le texte OCR mis en cache page par page, pour ne jamais relire deux fois un PDF.",
    ...
    hideIdentityMarkers: "Masquer les marqueurs d’identité",
    scanFolderDesc: "Limiter l’analyse à un dossier. Laisser vide pour tout analyser.",
    foldersRelativeDesc: "Les dossiers sont relatifs au vault. Laisser vide pour l’emplacement par défaut.",
    syncLogFolderDesc: "Dossier des journaux de synchronisation par appareil. Par défaut : la racine du vault.",
    syncLogIdDesc: "Identifie le journal de synchronisation de cet appareil. Un changement de dossier prend effet à la prochaine ouverture du vault.",
    canvasTagRule: "Une étiquette canvas doit commencer par # et n’utiliser que minuscules, chiffres, tirets, tirets bas ou barres obliques.",
    fallbackExamDesc: "Utilisé par les paquets sans profil propre, comme les paquets personnalisés. Ceux liés à un profil utilisent ses réglages d’examen.",
  },
  cardEdit: {
    typeMismatch: "Le type de modification {edit} ne correspond pas au type de carte {card}",
    vaultReadOnly: "Ce vault est ouvert en lecture seule.",
    canvasNotHere: "Les cartes Canvas ne se modifient pas ici.",
    couldNotRead: "Impossible de lire {file} : {reason}",
    cardNotFound: "Impossible de localiser cette carte dans la note source.",
    noteChanged: "La note a changé depuis le chargement de cette carte. Actualisez puis réessayez.",
    tableRowUnparseable: "La ligne du tableau n'est plus analysable.",
    tableRowChanged: "La ligne du tableau a changé depuis le chargement de cette carte.",
    clozeChanged: "Le contenu de la lacune a changé depuis le chargement de cette carte.",
    clozeRowUnparseable: "La ligne hôte de la lacune n'est plus analysable.",
    clozeRowInvalid: "La ligne hôte de la lacune n'est pas une ligne de tableau valide.",
    emptyHeaderSegment: "Segment de titre vide.",
    anchorNotHeader: "La ligne d'ancrage n'est pas un titre.",
    notATableRow: "Ligne de tableau non valide.",
    noNotesColumn: "Ce tableau n'a pas de colonne Notes.",
    separatorNotFound: "La ligne de séparation du tableau, nécessaire pour ajouter une colonne Notes, est introuvable.",
    frontEmpty: "Le texte du recto ne peut pas être vide.",
    headerEmpty: "Le texte du titre ne peut pas être vide.",
    clozeNeedsSpan: "Une lacune exige au moins un ==passage==.",
  },
};
