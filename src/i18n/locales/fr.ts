...
export const fr: Translations = {
  ...
  settings: {
    ai: {
      ...
      providerLocal: "Local (compatible OpenAI)",
      ...
      accountSignedOut: "Connectez-vous pour utiliser Decks Pro sans clé de licence.",
      ...
      baseUrl: "URL de base",
      baseUrlDesc: "Un point de terminaison compatible OpenAI accessible depuis cet appareil.",
